...
export const RING_WIDTH = [0.05, 0.05, 0.05, 0.05, 0.05, 0.1, 0.1, 0.15];

export const RING_INNER_RADIUS = [
  2.25, 2.5, 2.75, 3, 3.25, 3.5, 3.75, 4, 4.25, 4.5, 4.75, 5, 5.25, 5.5, 3.5,
  3.75, 4, 4.25, 4.5, 4.75, 5, 5.25, 5.5, 5.75, 6, 6.25, 6.5, 6.75,
];

export const RING_STATIC_RADIUS = [
  2.25, 2.5, 2.75, 3, 3.25, 3.5, 3.75, 4, 4.25, 4.5, 4.75, 5, 5.25, 5.5, 3.5, 3.75, 4,
