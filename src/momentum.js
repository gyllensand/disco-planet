...
!(function (t, e) {
  ...
  var n,
    ...
    h = (function () {
      function Tracker(e, n) {
        l || t(),
          (this.target = g(e)[0]),
          ((f[p(this.target)] = this)._props = {}),
          n && this.add(n);
      }
      Tracker.register = function register(e) {
        (n = e), t();
      };
      var e = Tracker.prototype;
      return (
        ...
        (Tracker.track = function track(e, n, i) {
          l || t();
          for (
            var r,
              o,
            ...
            for (r = q(c[f]) || new Tracker(c[f]), o = s.length; o--; )
              r.add(s[o], u[o] || u[0]);
            a.push(r);
          }
          return a;
        }),
        (Tracker.untrack = function untrack(t, e) {
          var n = (e || "").split(",");
        ...
        (Tracker.isTracking = function isTracking(t, e) {
          var n = q(t);
          return n && n.isTracking(e);
        }),
        (Tracker.getVelocity = function getVelocity(t, e) {
          var n = q(t);
          return n && n.isTracking(e)
            ? n.get(e)
  ...
  var v,
    ...
    S = {
      ...
      init: function init(t, e, n, i, r) {
        ...
        if ("auto" === e) {
          if (!o)
            return void console.warn("Woops.");
          e = o.getAll();
        }
